...
QENSFitSimultaneous::performFit(
  ...
  setProperty("OutputStatus",
              std::vector<std::string>(function->getNumberDomains(), status));
  setProperty("OutputChiSquared",
              std::vector<double>(function->getNumberDomains(), chiSquared));
